...
\begin{tikzpicture}[remember picture,overlay]%
\node [red,above =-0.1em,anchor=south west] at (#1\thecsh一音标一计数器.north west) {\small\fontGentiumPlus#2};
...
\colchunk{%
Deep in your \csh一音标{innermost}{/ˈɪnərmoʊst/} \csh一音标{being}{/ˈbiːɪŋ/ 存在}, you've always known you were \csh一音标{destined}{/ˈdɛstɪnd/ 预定的，注定的} to
