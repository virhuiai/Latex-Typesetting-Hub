...
\settowidth{\csh一音标一单词宽度}{#1~}%
\settototalheight{\csh一音标一单词高度}{#1~}%
\tikzmarknode{#1\thecsh一音标一计数器}{\makebox[0pt]{~}}#1%
\begin{tikzpicture}[remember picture,overlay]
\node [red,above =-0.1ex] at (#1\thecsh一音标一计数器.north) {\small\fontGentiumPlus#2};
...
\colchunk{%
Deep in your \csh一音标{innermost}{/ˈɪnərmoʊst/ 最内部的} \csh一音标{being}{/ˈbiːɪŋ/ 存在，生物}, you've always known you were \csh一音标{destined}{/ˈdɛstɪnd/ 预定的，注定的} to
...
% Deep in your \csh一音标{innermost}{/ˈɪnərmoʊst/ 最内部的} being, you've always known you were destined to
