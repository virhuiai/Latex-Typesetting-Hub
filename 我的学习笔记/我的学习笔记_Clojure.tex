...
\emph{肯定有更好的办法}。}
\colchunk{Deep in your innermost\csh一音标二{innermost}{/ˈɪnərmoʊst/ 最内部的} %
being%\csh一音标下{being}{/ˈbiːɪŋ/ 存在，生物}
, you've always known you were destined\csh一音标二{destined}{/ˈdɛstɪnd/ 注定的} 
to learn Clojure. Every time you held\csh一音标二{held}{/hɛld/ 持有} your keyboard aloft\csh一音标二{aloft}{/əˈlɔːft/ 在空中，向上}, crying out in
anguish\csh一音标二{anguish}{/ˈæŋɡwɪʃ/ 痛苦} over an \csh一音标{incomprehensible}{/ˌɪnkɑːmprɪˈhɛnsɪbəl/ 难以理解的}incomprehensible class hierarchy\csh一音标二{hierarchy}{/ˈhaɪəˌrɑːrki/ 层次结构}; every time you lay
awake at night, disturbing\csh一音标二{disturbing}{/dɪˈstɜːrbɪŋ/ 令人不安的} your loved ones with sobs\csh一音标二{sobs}{/sɑːbz/ 抽泣} over a
mutation\csh一音标二{mutation}{/mjuːˈteɪʃən/ 突变}-induced heisenbug\csh一音标二{heisenbug}{/ˈhaɪzənbʌɡ/ 海森堡虫\footnotemark[1]}; every time a race condition\csh一音标二{race condition}{/reɪs kənˈdɪʃən/ 竞态条件\footnotemark[2]} caused you to
pull\csh一音标二{pull}{/pʊl aʊt/ 拔出} out more of your everdwindling\csh一音标{everdwindling}{/ˈɛvər dwɪndlɪŋ/ 不断减少的} hair, some secret part of you has %
