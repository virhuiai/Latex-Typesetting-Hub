...
\switchcolumn
% 最后一行，clojure-noob.core=\textgreater，告诉你当前位于clojure-noob.core命名空间。稍后你会学习有关命名空间的知识，但现在要注意的是命名空间基本上与你的\emph{src/clojure_noob/core.clj}文件的名称匹配。另外，请注意REPL显示的版本为\emph{Clojure 1.7.0}，但正如之前提到的，无论使用哪个版本都可以正常工作。
% \switchcolumn[0]*
