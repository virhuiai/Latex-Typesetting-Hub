...
% \verb|\setcounter{chapter}{|\thechapter\verb|}|\\
% \verb|\setcounter{section}{|\thesection\verb|}|\\
% \verb|\setcounter{subsection}{|\thesubsection\verb|}|\\
% \verb|\setcounter{subsubsection}{|\thesubsubsection\verb|}|


%有以下latex命令，请定义一个命令，参数是计数器名：
\verb|\setcounter{chapter}{|\arabic{chapter}\verb|}|\\
\verb|\setcounter{section}{|\arabic{section}\verb|}|\\
\verb|\setcounter{subsection}{|\arabic{subsection}\verb|}|\\
\verb|\setcounter{subsubsection}{|\arabic{subsubsection}\verb|}|
 
\newcommand{\mshowc}[1]{\tt\string\setcounter\{#1\}\{\string\arabic\{\arabic{#1}\}\}}
\mshowc{chapter}
