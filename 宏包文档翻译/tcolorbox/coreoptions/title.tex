...
\begin{docTcbKey}{title}{=\meta{text}}{无默认值,初始为空}

创建以 \meta{text} 作为内容的标题行。\hfill
...
%   一些文本。
%   \begin{tcolorbox}[adjust text=center]
%     This is a centered text.
% \end{tcolorbox}

% 一些文本。
% \begin{tcolorbox}[adjust text=left top]
%     This is a left-aligned text on the top.
% \end{tcolorbox}

% 一些文本。
% \begin{tcolorbox}[adjust text=baseline]
%     This text is aligned with the baseline of the box.
% \end{tcolorbox}
% \end{exdispExample}
