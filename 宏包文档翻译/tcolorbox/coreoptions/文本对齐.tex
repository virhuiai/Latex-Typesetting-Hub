...
如果没有下部分，则|halign| 确定文本内容的水平\meta{对齐}方式。否则，|halign| 仅确定盒子上部分的水平\meta{alignment}方式。可行的\meta{alignment}值与相应的|/tikz/align|设置几乎相同，即使实现不同。
...
|halign lower| 确定盒子下部的水平 \meta{alignment}。 \meta{alignment} 的可行值与 \refKey{/tcb/halign} 相同。
