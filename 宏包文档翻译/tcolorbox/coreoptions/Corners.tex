...
% v3
\begin{tikzpicture}
    \node (all) {\cshSharpCornersTest{all}};
    % \node (west) at (all.west) {\cshSharpCornersTest{west}};
    \node (west) [left=2mm of all] {\cshSharpCornersTest{west}};
    \node (east) [right=2mm of all] {\cshSharpCornersTest{east}};

    \node (north) [above=2mm of all] {\cshSharpCornersTest{north}};
    \node (south) [below=2mm of all] {\cshSharpCornersTest{south}};

    \node (northwest) [above left=2mm of all] {\cshSharpCornersTest{northwest}};
    \node (northeast) [above right=2mm of all] {\cshSharpCornersTest{northeast}};

    \node (southwest) [below left=2mm of all] {\cshSharpCornersTest{southwest}};
    \node (southeast) [below right=2mm of all] {\cshSharpCornersTest{southeast}};
  \end{tikzpicture}
...
\newtcbox{\cshRoundedCorners}[1]{on line,size=title,arc=2mm,colframe=red!75!black,colback=red!5!white,
enlarge top by=0.5mm,enlarge bottom by=0.5mm,sharp corners,rounded corners=#1}
\newcommand\cshRoundedCornersTest[1]{\cshRoundedCorners{#1}{#1}}

\begin{tikzpicture}
\node (all) {\cshRoundedCornersTest{all}};
% \node (west) at (all.west) {\cshRoundedCornersTest{west}};
\node (west) [left=2mm of all] {\cshRoundedCornersTest{west}};
\node (east) [right=2mm of all] {\cshRoundedCornersTest{east}};

\node (north) [above=2mm of all] {\cshRoundedCornersTest{north}};
\node (south) [below=2mm of all] {\cshRoundedCornersTest{south}};

\node (northwest) [above left=2mm of all] {\cshRoundedCornersTest{northwest}};
\node (northeast) [above right=2mm of all] {\cshRoundedCornersTest{northeast}};

\node (southwest) [below left=2mm of all] {\cshRoundedCornersTest{southwest}};
\node (southeast) [below right=2mm of all] {\cshRoundedCornersTest{southeast}};
\end{tikzpicture}
