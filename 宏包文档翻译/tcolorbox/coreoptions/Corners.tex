...
\begin{tikzpicture}
    ...
    \node (west) [left=of all] {\cshSharpCornersTest{west}};
    \node (east) [right=of all] {\cshSharpCornersTest{east}};

    \node (north) [above=of all] {\cshSharpCornersTest{north}};
    \node (south) [below=of all] {\cshSharpCornersTest{south}};

    \node (northwest) [above left=of all] {\cshSharpCornersTest{northwest}};
    \node (northeast) [above right=of all] {\cshSharpCornersTest{northeast}};

    \node (southwest) [below left=of all] {\cshSharpCornersTest{southwest}};
    \node (southeast) [below right=of all] {\cshSharpCornersTest{southeast}};
  \end{tikzpicture}
...
\node (west) [left=of all] {\cshRoundedCornersTest{west}};
\node (east) [right=of all] {\cshRoundedCornersTest{east}};

\node (north) [above=of all] {\cshRoundedCornersTest{north}};
\node (south) [below=of all] {\cshRoundedCornersTest{south}};

\node (northwest) [above left=of all] {\cshRoundedCornersTest{northwest}};
\node (northeast) [above right=of all] {\cshRoundedCornersTest{northeast}};

\node (southwest) [below left=of all] {\cshRoundedCornersTest{southwest}};
\node (southeast) [below right=of all] {\cshRoundedCornersTest{southeast}};
\end{tikzpicture}
