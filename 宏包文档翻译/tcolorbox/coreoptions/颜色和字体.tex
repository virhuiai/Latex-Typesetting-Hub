...
设置upper部分的文本的颜色。\hfill Sets the text \meta{color} of the upper part.
...
设置lower部分的文本的颜色。\hfill Sets the text \meta{color} of the lower part.
...
设置标题的文本的颜色。\hfill Sets the title text \meta{color} of the box.
...
附加 \meta{text} 到{\bf upper}部分的内容之前（例如字体设置）。
