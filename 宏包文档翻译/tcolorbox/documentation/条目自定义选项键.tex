...
设置相同\meta{选项}的快捷方式，适用于\refKey{/tcb/doc raster command}、\refKey{/tcb/doc raster environment}、\refKey{/tcb/doc raster key}和\refKey{/tcb/doc raster path}。
\end{docTcbKeys}
...
设置相同的\meta{选项}的快捷方式，适用于\refKey{/tcb/doc head command}、\refKey{/tcb/doc head environment}、\refKey{/tcb/doc head key}和\refKey{/tcb/doc head path}。
\end{docTcbKey}
...
设置相同\meta{选项}的快捷方式，适用于\refKey{/tcb/before doc body command}、\refKey{/tcb/before doc body environment}、\refKey{/tcb/before doc body key}和\refKey{/tcb/before doc body path}。
\end{docTcbKey}
...
为 \refKey{/tcb/after doc body command}、\refKey{/tcb/after doc body environment}、\refKey{/tcb/after doc body key} 和 \refKey{/tcb/after doc body path} 设置相同的 \meta{选项} 的快捷方式。
\end{docTcbKey}