...
\begin{boxTcbKey}{yshift*}{=\meta{length}}{no default, initially |0pt|}
Sets \refKeyLe{/tcb/boxtitle/yshift} and \refKeyLe{/tcb/boxtitle/yshifttext}
the same time.\\
\refKeyLe{/tcb/boxtitle/yshifttext} is only set if necessary.

同时设置 \refKeyLe{/tcb/boxtitle/yshift} 和 \refKeyLe{/tcb/boxtitle/yshifttext}。

仅在必要时才设置 \refKeyLe{/tcb/boxtitle/yshifttext}。
