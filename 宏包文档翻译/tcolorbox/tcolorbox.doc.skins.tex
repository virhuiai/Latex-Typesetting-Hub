...
% \input{skins/skins}%v2 2023-1014 
% \include*{skins/样式选项键}% todo tikz   v2 2023-1014 


\include*{skins/盒子标题选项键}%TODO 以下
% %\clearpage
...
% %\clearpage
% The example for \refKeyLe{/tcb/clip upper} sizes the box according to
...
% They may be used with or without the \refKeyLe{/tcb/segmentation engine}.
...
%   always be rounded except for \refKeyLe{/tcb/sharp corners}.
% \begin{dispExample}
...
%   Adds a new shadow with standard dimensions to the stack of shadows.
%   This shadow is identical to \refKeyLe{/tcb/drop shadow}.
...
%   Adds a new shadow with standard dimensions to the stack of shadows.
%   This shadow is identical to \refKeyLe{/tcb/drop midday shadow}.
% \begin{dispExample*}{sbs,lefthand ratio=0.7}
...
%   Adds a new fuzzy shadow with standard dimensions to the stack of shadows.
%   This shadow is identical to \refKeyLe{/tcb/drop fuzzy shadow}.
% \begin{dispExample*}{sbs,lefthand ratio=0.7}
...
%   Adds a new fuzzy shadow with standard dimensions to the stack of shadows.
%   This shadow is identical to \refKeyLe{/tcb/drop fuzzy midday shadow}.
% \begin{dispExample*}{sbs,lefthand ratio=0.7}
...
%   more rounded depending on several factors. But \refKeyLe{/tcb/sharp corners}
%   have sharp shadows.
%   \begin{marker}
...
% Such shadows can be added directly to the frame path using \refKeyLe{/tcb/frame style}.
...
%   used to draw the color box, see . If this option is
...
%   Removes all options given by \refKeyLe{/tcb/tikz}.
% \end{docTcbKey}
...
%   Removes all code given by \refKeyLe{/tcb/at begin tikz}.
% \end{docTcbKey}
...
%   Removes all code given by \refKeyLe{/tcb/at end tikz}.
% \end{docTcbKey}
...
%   \refKeyLe{/tcb/underlay} overwrites this key.
% \end{docTcbKey}
...
%   \refKeyLe{/tcb/underlay unbroken} and
%   \refKeyLe{/tcb/underlay first} together.
%   \refKeyLe{/tcb/underlay} overwrites this key.
% \end{docTcbKey}

% \begin{docTcbKey}{underlay middle and last}{=\meta{graphical code}}{no default, initially unset}
%   This is an abbreviation for setting
%   \refKeyLe{/tcb/underlay middle} and
%   \refKeyLe{/tcb/underlay last} together.
%   \refKeyLe{/tcb/underlay} overwrites this key.
% \end{docTcbKey}
...
%   This is an abbreviation for setting
%   \refKeyLe{/tcb/underlay first} and
%   \refKeyLe{/tcb/underlay middle} together.
%   \refKeyLe{/tcb/underlay} overwrites this key.
% \end{docTcbKey}
...
%   If the box is set to be \refKeyLe{/tcb/breakable} and \emph{is} broken actually,
%   then the \meta{graphical code} is added to the box drawing process.
%   \refKeyLe{/tcb/finish} overwrites this key.
% \end{docTcbKey}
...
%   This is an abbreviation for setting
%   \refKeyLe{/tcb/finish unbroken} and
%   \refKeyLe{/tcb/finish first} together.
%   \refKeyLe{/tcb/finish} overwrites this key.
% \end{docTcbKey}

% \begin{docTcbKey}{finish middle and last}{=\meta{graphical code}}{no default, initially unset}
%   This is an abbreviation for setting
%   \refKeyLe{/tcb/finish middle} and
%   \refKeyLe{/tcb/finish last} together.
%   \refKeyLe{/tcb/finish} overwrites this key.
% \end{docTcbKey}
...
%   This is an abbreviation for setting
%   \refKeyLe{/tcb/finish first} and
%   \refKeyLe{/tcb/finish middle} together.
%   \refKeyLe{/tcb/finish} overwrites this key.
% \end{docTcbKey}

% %\clearpage
% \subsection{Hyper Option Keys}\label{subsec:hyper}
% All options of this section need the package |hyperref| 
% to be loaded separately. All these options are implemented as
% \refKeyLe{/tcb/finish} and can be disabled by \refKeyLe{/tcb/no finish}.

% \begin{marker}
% If the package |hyperref|  is not loaded or if
...
%   \meta{marker} which was given by |\label| or \refKeyLe{/tcb/label} or \refKeyLe{/tcb/phantomlabel}.
...
%   Identical to \refKeyLe{/tcb/hyperref}, but only the \textit{interior} of a
...
%   Identical to \refKeyLe{/tcb/hyperref}, but only the \textit{title} of a
...
%   Identical to \refKeyLe{/tcb/hyperref}, but only the given \tikzname\ \meta{node}
...
%   \refKeyLe{/tcb/underlay}, \refKeyLe{/tcb/overlay} or \refKeyLe{/tcb/finish}.
%   If the later is used, define the node \emph{before} \refKeyLe{/tcb/hyperref node}
%   is applied.
%   \begin{dispExample*}{sbs,lefthand ratio=0.7}
% % \section{Library skins}\label{sec:skins}%
...
%   The whole \textit{frame} of a |tcolorbox| is make an active hyperlink for a
%   \meta{marker} which was given by |\hypertarget| or \refKeyLe{/tcb/hypertarget}.
%   Such, the |tcolorbox| is made a clickable button (depending on the previewer).
%   \begin{dispExample*}{sbs,lefthand ratio=0.7}
% % \usepackage{hyperref}%
% \begin{tcolorbox}[enhanced,
...
%   Identical to \refKeyLe{/tcb/hyperlink}, but only the \textit{interior} of a
%   |tcolorbox| is made a hyperlink (without frame and title).
% \end{docTcbKey}

% \begin{docTcbKey}[][doc new=2017-02-03]{hyperlink title}{=\meta{marker}}{no default, initially unset}
%   Identical to \refKeyLe{/tcb/hyperlink}, but only the \textit{title} of a
%   |tcolorbox| is made a hyperlink.
% \end{docTcbKey}

% \begin{docTcbKey}[][doc new=2017-02-03]{hyperlink node}{=\marg{marker}\marg{node}}{no default, initially unset}
%   Identical to \refKeyLe{/tcb/hyperlink}, but only the given \tikzname\ \meta{node}
%   is made a hyperlink. This \meta{node} may be |frame|, |interior|, |title|, or
%   any other named node used for drawing the |tcolorbox|.
%   The \meta{node} may be defined inside
%   \refKeyLe{/tcb/underlay}, \refKeyLe{/tcb/overlay} or \refKeyLe{/tcb/finish}.
%   If the later is used, define the node \emph{before} \refKeyLe{/tcb/hyperlink node}
%   is applied.
% \end{docTcbKey}
...
%   Identical to \refKeyLe{/tcb/hyperurl}, but only the \textit{interior} of a
%   |tcolorbox| is made a hyperlink (without frame and title).
% \end{docTcbKey}

% \begin{docTcbKey}[][doc new=2017-02-03]{hyperurl title}{=\meta{url}}{no default, initially unset}
%   Identical to \refKeyLe{/tcb/hyperurl}, but only the \textit{title} of a
%   |tcolorbox| is made a hyperlink.
% \end{docTcbKey}

% \begin{docTcbKey}[][doc new=2017-02-03]{hyperurl node}{=\marg{url}\marg{node}}{no default, initially unset}
%   Identical to \refKeyLe{/tcb/hyperurl}, but only the given \tikzname\ \meta{node}
%   is made a hyperlink. This \meta{node} may be |frame|, |interior|, |title|, or
%   any other named node used for drawing the |tcolorbox|.
%   The \meta{node} may be defined inside
%   \refKeyLe{/tcb/underlay}, \refKeyLe{/tcb/overlay} or \refKeyLe{/tcb/finish}.
%   If the later is used, define the node \emph{before} \refKeyLe{/tcb/hyperurl node}
%   is applied.
% \end{docTcbKey}


% \begin{docTcbKey}[][doc new=2017-02-03]{hyperurl*}{=\marg{options}\marg{url}}{no default, initially unset}
%   Identical to \refKeyLe{/tcb/hyperurl}, but additional |hyperref| 
...
%   Identical to \refKeyLe{/tcb/hyperurl interior}, but additional |hyperref| 
%   \meta{options} are applied.
% \end{docTcbKey}

% \begin{docTcbKey}[][doc new=2017-02-03]{hyperurl* title}{=\marg{options}\marg{url}}{no default, initially unset}
%   Identical to \refKeyLe{/tcb/hyperurl title}, but additional |hyperref| 
%   \meta{options} are applied.
% \end{docTcbKey}
...
%   Identical to \refKeyLe{/tcb/hyperurl node}, but additional |hyperref| 
%   \meta{options} are applied.
% \end{docTcbKey}
...
% sets the \refKeyLe{/tcb/fit algorithm} to |squeeze|. Especially,
...
% (e.g. counter changes) is not executed anymore! Also, \refKeyLe{/tcb/remember as}
% will not have any effect. You may exclude critical code with
% \refComLe{tcbinterruptdraftmode} / \refComLe{tcbcontinuedraftmode}
...
%   until a following \refComLe{tcbcontinuedraftmode} is detected.\par
%   If the compilation is not in \emph{draft mode}, nothing happens and a following
%   \refComLe{tcbcontinuedraftmode} will not start the \emph{draft mode}.
%   \begin{marker}
...
%   \refComLe{tcbinterruptdraftmode}. Nothing happens, if there was no draft
%   mode before \refComLe{tcbinterruptdraftmode}.
%   \begin{marker}
%   Code, which is place between \refComLe{tcbinterruptdraftmode} and
%   \refComLe{tcbcontinuedraftmode} is shielded from \emph{draft mode}.
%   \end{marker}
% \end{docCommand}
