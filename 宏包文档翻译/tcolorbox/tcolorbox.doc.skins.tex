...
%   Identical to \refKey{/tcb/hyperurl}, but additional |hyperref| 
...
%   Identical to \refKey{/tcb/hyperurl interior}, but additional |hyperref| 
%   \meta{options} are applied.
% \end{docTcbKey}

% \begin{docTcbKey}[][doc new=2017-02-03]{hyperurl* title}{=\marg{options}\marg{url}}{no default, initially unset}
%   Identical to \refKey{/tcb/hyperurl title}, but additional |hyperref| 
%   \meta{options} are applied.
% \end{docTcbKey}
...
%   Identical to \refKey{/tcb/hyperurl node}, but additional |hyperref| 
%   \meta{options} are applied.
% \end{docTcbKey}
