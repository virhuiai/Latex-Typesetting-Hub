...
\input{\cshInputPathVal/csh_DocValueAndTwoDesc.tex}
\begin{document}
\VerbatimFootnotes
...
\newtcbox{\csh渐变盒子V}[1][yellow]{tcbox raise base, opacityback=0.5,opacityframe=0.5,shrink tight,nobeforeafter,extrude top by=2mm,extrude bottom by=2mm,colframe=#1,colback=#1!25!white
}
% \csh渐变盒子V{text}
% \csh渐变盒子V[red]{text}
\newtcbox{\csh渐变盒子H}[1][yellow]{tcbox raise base, opacityback=0.5,opacityframe=0.5,shrink tight,nobeforeafter,extrude left by=2mm,extrude right by=2mm,colframe=#1,colback=#1!25!white
}

\newtcbox{\csh渐变盒子}[1][yellow]{tcbox raise base, opacityback=0.5,opacityframe=0.5,shrink tight,nobeforeafter%
,extrude by=2mm,
colframe=#1,colback=#1!25!white
}




% \input{tcolorbox.doc.abstract}%译 done 摘要和目录 v6 20231008 v7 20231029
% \input{tcolorbox.doc.intro_v4}%1【v5 20231029】【译 done】 v4 2023.3.11 todo 有额外说明，后面可以整理出来  /v5 20231029/
% \input{tcolorbox.doc.quickref}%2译  done 2023.1.8    todo 可以学习pgf的划定距离的例子 到时list的Latex教程中可以使用
% \input{tcolorbox.doc.coremacros}%3-创建盒子的宏命令【v7 2023 1029】译 done v3 2023.3.11  v4 2023.0322 v5 2023.0921 %v6 2023 10 10  ||3-创建盒子的宏命令
\input{tcolorbox.doc.coreoptions}%译 done v3 2023.3.12  111页 /v4 20231025
% \input{tcolorbox.doc.initoptions}%译 done 2023.1.23  5-initoptions  12页  后面将中英的分开
% \input{tcolorbox.doc.sidebyside}%译 done 2023.1.23 lefthand width=\wd\mysavebox  v3 2023-10-13
% \include*{tcolorbox.doc.verbatim}%译 done 2023.1.23|v2 20230325  v3 2023-1014
% \include*{tcolorbox.doc.recording}%%译 done 2023.1.24|v2 20230325 v3 2023 0924  v4 2023-1014   添加了多个类型的，棒
% \include*{tcolorbox.doc.technical}%todo 不必要，如何只是使用 todo 最后看看这边吧
...
% \input{tcolorbox.doc.raster}% v1 20230328
% \setcounter{section}{16}
% \input{tcolorbox.doc.listings}% v1 2023 0314  v2 2023 0325/ v3.20231025  17节
...
% \input{tcolorbox.doc.poster}%todo 译但没看内容
...
% \input{tcolorbox.doc.documentation}% v1 2023 0314
% \appendix
