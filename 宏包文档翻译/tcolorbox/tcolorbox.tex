...
\input{tcolorbox.doc.intro_v4}%译  done v4 2023.3.11 todo 有额外说明，后面可以整理出来  v5 20231029
\end{document}
% \input{tcolorbox.doc.quickref}%译  done 2023.1.8  
% \input{tcolorbox.doc.coremacros}%译 done v3 2023.3.11  v4 2023.0322 v5 2023.0921 %v6 2023 10 10  ||3-创建盒子的宏命令
