...
\includeonly{coremacros/tcolorboxEnv}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
...
% \input{tcolorbox.doc.technical}%todo 不必要，如何只是使用
% \setcounter{section}{9}
% \input{tcolorbox.doc.skins}%todo 翻译了一些
...
% \input{tcolorbox.doc.listings}% v1 2023 0314
