...
\begin{marker}
The option \refKeyLe{/tcb/only} belonged to the base package before version 4.20.
\end{marker}
\end{docTcbKey}
...
Sets the \refKeyLe{/tcb/beamer hidden} style in dependency of
a |beamer| \meta{overlay specification}.
\refKeyLe{/tcb/beamer hidden} can be redefined for customization.
\end{docTcbKey}
...
\refKeyLe{/tcb/hide}. The style can be redefined.
\begin{dispListing}
\tcbset{
...
Sets the \refKeyLe{/tcb/beamer alerted} style in dependency of
a |beamer| \meta{overlay specification}.
\refKeyLe{/tcb/beamer alerted} can be redefined for customization.
\end{docTcbKey}


\begin{docTcbKey}[][doc new={2019-03-01}]{beamer alerted}{}{style, no options, initially |fuzzy halo|}
This style is not intended to be used directly, but in concealed way by applying
\refKeyLe{/tcb/alert}. The style can be redefined.
\begin{dispListing}
\tcbset{
...
The following examples use \refEnvLe{tcbitemize} from \mylib{raster} for
