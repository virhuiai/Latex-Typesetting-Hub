...
% 《\citetitle{sturm:latex}》\cite{sturm:latex}
...
% 版本2.00的重要更新是添加了可断的盒子的支持。
% 此功能使得可以在不需要自动断行的情况下，将包应用于新的应用程序而无需对核心包产生太大影响。
% 版本2.20添加了经常被要求的列表的\enquote{并排}模式。
% 版本3.00引入了带框标题，并改进了叠加、底图、装饰和自定义代码扩展的选项。
...
% 
% 我感谢所有给我写信的人，他们通过发送错误报告和对新功能提出的意见来支持这个包。
...
通常，|tcolorbox| 将作为主要的\LaTeX\ 发行版的一部分进行安装，对于用户来说没有什么特殊的要做。
