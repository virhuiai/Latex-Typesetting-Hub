...
This macro reverts \refComLe{tcbpatcharcangular}, i.e., the patch from
\refComLe{tcbpatcharcangular} is replaced by the original code.
\end{docCommand}
...
%  to the \TeX\ \meta{register}.
  ...
  to an existing |tikz| \meta{node}. \refComLe{tcbhypernode} can only
