...
% Optionally, such a box can be split in an upper and a lower part. 
这个文本盒子环境的upper和lower两部分是可选的。
% The package |tcolorbox| can be used for the setting of \LaTeX\ examples 
% where one part of the box displays the source code and the other part shows the output. 
