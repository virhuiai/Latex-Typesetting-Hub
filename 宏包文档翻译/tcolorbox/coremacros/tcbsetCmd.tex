...
% 为当前的 \TeX\ 组中为后续的 {tcolorbox} 设置选项。 默认情况下，这不适用于嵌套的盒子，请参见 \Vref{subsec:everybox}。\parpar
设置当前的 \TeX\ 组中后续 |tcolorbox| 的选项。 默认情况下，这不适用于嵌套的盒子，请参见 \Vref{subsec:everybox}。\parpar
% \end{stripedbox}
% \begin{stripedbox}
