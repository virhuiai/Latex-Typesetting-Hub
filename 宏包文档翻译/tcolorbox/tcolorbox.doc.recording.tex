...
\begin{引述之言}{virhuiai}
有多个的情况下,tcbstartrecording需要指定不同的文件名,最终可以用input命令指定具体的文件名,直接导入内容。
\end{引述之言}
\end{docCommand}
...
\tcbstartrecording[\jobname.recordsA]
\begin{exercise}
第A的题目
\tcblower
第A的答案
...
\tcbstartrecording[\jobname.recordsB]
