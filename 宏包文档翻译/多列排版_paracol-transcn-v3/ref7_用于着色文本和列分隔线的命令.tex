...
\switchcolumn\item
如果\LaTeX 的排版参数 \!\columnseprule! 的线条宽度具有非零值（例如，0.4,|pt|以遵守标准线条厚度），则会绘制线条。线条不会绘制在\pwstuff{}上，即\Preenv{}和\postenv，\pwise{}浮动对象或（\mgfnote{}或非合并的）\Scfnote{}上，当然也不会绘制在\mctext{}上。因此，如果页面上有\mctext{}，则它们会打破线条，如下面的红色规则示例所示。
