...
\usepackage[a3paper,landscape,left=2.25cm,right=2.25cm,top=2.5cm,bottom=2.5cm,nohead]{geometry}
\usepackage{paracol}
...
% \graphicspath{{../../images/}}
\graphicspath{{/Users/virhuiai/hlProjects/Latex-Typesetting-Hub/宏包文档翻译/pgf-v2/images/}}
% 
