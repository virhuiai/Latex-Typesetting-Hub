...
\switchcolumn
\item 在加载 \Gm 之前，更改第一页的布局，并保留其他页的默认布局。使用 |pass| 选项，|\newgeometry| 和 |\restoregeometry|。
\begin{verbatim}
\documentclass{book}
\usepackage[pass]{geometry}
% 'pass' disregards the package layout,
