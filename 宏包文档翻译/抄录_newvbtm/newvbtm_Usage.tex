...
\switchcolumn
请注意，在星号版本中，例如|tabverbatim*|，|<TAB>|被翻译为一个空格序列\verb*! !。
...
|\(re)newtabverbatim|.
\switchcolumn
对于希望对|\(re)newverbatim|进行操作而不是对|\(re)newtabverbatim|进行操作的\TeX{}专家，也可以通过命令|\VVBbegintab|和|\VVBendtab|访问\meta{beg-def-for-tab}和\meta{end-def-for-tab}的神奇内容。
