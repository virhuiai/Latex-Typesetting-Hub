...
\switchcolumn
\item[breaksymbolindentleft (维度) (\meta{breaksymbolindentleftnchars})]
...
允许将 |breaksymbolindentleft| 指定为字符的整数数量，而不是作为维度（假设使用等宽字体）。
\switchcolumn[0]*%%%%%%%%%%%%
...
\switchcolumn
\item[breaksymbolindentright (维度) (\meta{breaksymbolindentrightnchars})]
