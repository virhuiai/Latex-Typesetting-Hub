...
定义个性化定制环境很容易。你可以使用\cs{RecustomVerbatimEnvironment}宏重新定义现有的环境，或者使用\cs{DefineVerbatimEnvironment}宏创建你自己的环境\footnote{%
\ifChangeBar\begin{changebar}\fi
针对verbatim命令，也存在\cs{CustomVerbatimCommand}和\cs{RecustomVerbatimCommand}宏；例如：
