...
% The titlepage
% \input{pgfmanual-titlepage.tex}%封面页，已经翻译
% pgfmanual-titlepage


\newcommand{\mshowc}[1]{\noindent\tt\string\setcounter\{#1\}\{\arabic{#1}\}\newline}

% \include{pgfmanual-en-introduction-cn.tex}%v1 2023-0925 5页
% % \setcounter{section}{1}
% % \setcounter{subsection}{6}
% % \setcounter{subsubsection}{0}
% \part{Tutorials and Guidelines\\教程和指南}
...
% \noindent 为了帮助您开始使用 \tikzname，这份手册以教程开头，而不是长篇的安装和配置部分。这些教程解释了系统的所有基础和一些更高级的特性，但并未深入到所有的细节。这一部分还包含了一些关于您在使用 \tikzname 创建图形时应该如何进行的指南。
...
% % \setcounter{subsection}{6}
% % \setcounter{subsubsection}{0}
% \include{pgfmanual-en-tutorial-cn.tex}% 20page v1 2023-09-25
% % \setcounter{section}{2}
% % \setcounter{subsection}{22}
% % \setcounter{subsubsection}{0}
%  % \include{pgfmanual-en-tutorial-nodes}%
% \include{pgfmanual-en-tutorial-nodes-cn}% v1 2023 09 26
% % \setcounter{section}{3}
% % \setcounter{subsection}{14}
% % \setcounter{subsubsection}{0}
% \include{pgfmanual-en-tutorial-Euclid-cn}
...
% \include{pgfmanual-en-tutorial-chains-cn}
...
% \setcounter{subsubsection}{4}
% \setcounter{page}{74}
% \include{pgfmanual-en-tutorial-map-cn}


% \include{pgfmanual-en-guidelines}%v1 有打印 /Volumes/RamDisk/xelatexOut/text-en/7关于图形的指导原则.pdf

% \setcounter{section}{7}
% \setcounter{subsection}{7}
% \setcounter{subsubsection}{0}

% \part{Installation and Configuration\\安装和配置}
...
% \noindent 本部分将解释系统的安装过程。通常情况下，有人已经为您的系统完成了安装，所以您可以跳过本部分；但如果情况不是这样，而且您是那个不幸的人，需要进行安装，请阅读本部分。
% \vskip1cm
...
%      \\当前候选的五状态忙碌海狸机。据推测，该图灵机在具有五个状态和带字母表${0, 1}$的所有图灵机中，在停机前会写下最多数量的$1$。证明这个猜想是一个未解决的研究问题。
...
% \include{pgfmanual-en-installation-cn}

% \include{pgfmanual-en-license}% todo 未翻译
% \setcounter{section}{9}
% \setcounter{subsection}{4}
% \setcounter{subsubsection}{12}

% \include{pgfmanual-en-drivers}%  todo 未翻译
...
% \part{Ti\emph{k}Z ist \emph{kein} Zeichenprogramm\\Ti\emph{k}Z不是绘图软件}
% \label{part-tikz}
...
% \include{pgfmanual-en-tikz-design-cn}%打印了
% \include{pgfmanual-en-tikz-scopes-cn}%v1 2023-10-03
% \include{pgfmanual-en-tikz-coordinates-cn}%v1 2023-10-03
% \include{pgfmanual-en-tikz-paths-cn}%v1 2023-10-03
% \include{pgfmanual-en-tikz-actions-cn}%v1 2023-10-06
% \include{pgfmanual-en-tikz-arrows-cn}%v1 2023-10-06 44页 未看
%\include{pgfmanual-en-tikz-shapes-cn} %v1 2023-10-06 53页 看1
% \include{pgfmanual-en-tikz-pics-cn}%v1 2023-10-06 10页 
% \include{pgfmanual-en-tikz-graphs-cn}%64page, %v1 2023-10-07
% \include{pgfmanual-en-tikz-matrices-cn}%page 14   %v1 2023-10-07  在总的331page
% \include{pgfmanual-en-tikz-trees-cn}%%v1 2023-10-07 page 14
% \include{pgfmanual-en-tikz-plots-cn}%%v1 2023-10-08 未看
% \include{pgfmanual-en-tikz-transparency-cn}%v1 2023-10-08 未看  page18
% \include{pgfmanual-en-tikz-decorations-cn}%v1 2023-10-08 未看 page 8
% \include{pgfmanual-en-tikz-transformations-cn}%v1 2023-10-08 未看 page 8


% \include{pgfmanual-en-tikz-animations-cn}% v1 2023-10-08 未看 page 47
...
% \part{Graph Drawing\\图形绘制}
% \label{part-gd}

% {\Large \emph{by Till Tantau et al.}\\作者：Till Tantau 等人}
...
% implement new algorithms in the Lua programming language. 

% \emph{图形绘制算法}可以为您计算图形的布局，这是一项复杂的工作。\tikzname\ 提供了强大的图形绘制算法，但您也可以使用Lua编程语言实现新的算法。
...
%     您需要使用Lua\TeX\ 来排版本手册的这部分内容（并且还需要使用算法图形绘制）。

% \fi

% % a
% \include{pgfmanual-en-gd-overview-cn} % 只是翻译，未使用luatex  
% b
...
% 在本部分中，记录了库包。它们提供了额外的预定义图形对象，如新的箭头头或新的绘图标记，但有时也扩展了基本的\pgfname\ 或\tikzname\ 系统。这些库不会默认加载，因为许多用户不需要它们。
...
% \include{pgfmanual-en-library-3d-cn}
% \include{pgfmanual-en-library-angles-cn}%


% \include{pgfmanual-en-library-arrows-cn}%不推荐，先不翻译

% \include{pgfmanual-en-library-automata-cn}%v1 未看
