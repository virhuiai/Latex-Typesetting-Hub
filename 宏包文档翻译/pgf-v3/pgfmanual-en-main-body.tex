...
\begin{document}%%%%开始的地方
 

\pgfmathsetseed{1}%设置了随机数生成器的种子为1。

% \input{pgfmanual-titlepage.tex}% 标题页
% \label{table-of-contents}
% \tableofcontents
% \clearpage
% \include{pgfmanual-en-introduction}%1 简介
% \columnratio{0.55}
% \begin{paracol}{2}
...
% \end{codeexample}
% \include{pgfmanual-en-tutorial}%v2 2023 1216  从抛物线开始未做到笔记中
% \include{pgfmanual-en-tutorial-nodes}%v2 2023 12 19
